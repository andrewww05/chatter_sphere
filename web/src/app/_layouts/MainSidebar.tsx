        ...
        <aside className="w-xs px-4 py-8 flex flex-col justify-between">
                            ...
                            <li key={item.path}>
                                <div className="flex justify-between items-center w-full hover:cursor-pointer">
                                    <div className={className}>
                                        ...
                                        <a
                                            href={item.path}
                                            className="break-words max-w-48"
                                        >
                                            {item.name}
                                        </a>
                                    </div>
                                    ...
                                    <div>
                                        <span className="flex items-center rounded-full bg-primary-bg size-7 inset-ring inset-ring-primary-border-hover">
                                            <span className="w-full text-sm font-medium text-primary-text text-center">
                                                5
                                            </span>
                                        </span>
                                    </div>
            ...
            <div className="flex items-center justify-between">
                <div className="flex flex-row items-center gap-3">
                    <div>
                        <Image
                            ...
                            alt="pfp"
                            src={
                                'https://d2zia2w5autnlg.cloudfront.net/200164/6421b0bf9a534-large'
                            }
                        />
                    </div>
                ...
                <div className="flex justify-center items-center">
                    <svg
                        className="size-6 p-3 text-dark-gray hover:text-red-500"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        strokeWidth={1.75}
