        ...
        <div className="relative z-10 py-24 px-6 flex flex-col w-[95%] sm:w-[80%]  max-w-144 mx-auto h-full justify-between ">
          <div className="flex flex-col gap-20">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-3xl md:text-5xl font-bold md:font-medium">Step into the Sphere! 💫</p>
              <p className="text-base">A world of chats, vibes, and endless connections is waiting for you..</p>
            </div>
          </div>
          <div className="flex flex-col align-middle items-center pt-12 gap-6 text-center">
            <button onClick={() => signIn("google")} className="block cursor-pointer bg-primary hover:bg-primary-hover py-3 w-full rounded-lg text-white font-bold">
              <div className="flex items-center justify-center gap-3 px-[10%]">
                ...
                <span className="text-sm">Sign in to start your journey</span>
              </div>
            </button>
            <p className='pb-8'>By clicking <b>“Sign in”</b>, you agree to <span className="text-primary font-bold">the terms and conditions</span> and <span className="text-primary font-bold">privacy policy.</span></p>
          </div>
        </div>
      </div>
